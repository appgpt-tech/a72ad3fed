...
const DataScienceTitle = () => {
  const record = useRecordContext();
  return <span>DataScience {record ? `"${ record.title }"` : ""}</span>;
};
...
export const DataScienceEdit = () => (
                    <Edit title={<DataScienceTitle />}>
                      <SimpleForm>
...
export const DataScienceCreate = () => (
                                  <Create>
                                    <SimpleForm>
                                      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
                                        <Grid item xs={4}>

...
const ProjectManagementTitle = () => {
  ...
  return <span>ProjectManagement {record ? `"${ record.title }"` : ""}</span>;
};
...
export const ProjectManagementEdit = () => (
                    <Edit title={<ProjectManagementTitle />}>
                      <SimpleForm>
...
export const ProjectManagementCreate = () => (
                                  <Create>
                                    <SimpleForm>
                                      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
                                        <Grid item xs={4}>
